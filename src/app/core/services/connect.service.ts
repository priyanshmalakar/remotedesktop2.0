...
async destroy() {
    ...
    if (!document.getElementById('mediaControlsBox')) {
        ...
        hostCameraBtn?.addEventListener('click', async () => {
            ...
            if (this.hostCameraEnabled) {
                hostCameraBtn.style.background = 'linear-gradient(135deg, #06b6d4, #0891b2)';
        ...
        hostMicBtn?.addEventListener('click', async () => {
            ...
            if (this.hostMicEnabled) {
                hostMicBtn.style.background = 'linear-gradient(135deg, #06b6d4, #0891b2)';
        ...
        [hostCameraBtn, hostMicBtn].forEach(btn => {
            ...
            btn?.addEventListener('mouseleave', () => {
                if (!((btn.id === 'hostCameraToggle' && this.hostCameraEnabled) || 
